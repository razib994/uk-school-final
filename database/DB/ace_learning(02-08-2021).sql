...
(43, 'Academic', 'Students', 'school/student-users', 42, NULL, NULL, 1, '2021-08-01 01:01:37', '2021-08-01 01:01:37'),
(44, 'Academic', 'Teachers', 'school/teacher-user', 42, NULL, NULL, 1, '2021-08-01 01:07:16', '2021-08-01 01:07:16');
...
(32, '2021_08_01_071434_create_students_table', 11),
(33, '2021_08_01_072240_create_teachers_table', 11);
...
INSERT INTO `students` (`id`, `student_id`, `address`, `email`, `contact_no`, `first_name`, `middle_name`, `last_name`, `dob`, `gender`, `parent_name`, `parent_contact_no`, `parent_email`, `remarks`, `status`, `created_at`, `updated_at`) VALUES
(1, 'A-101', '', '', '', '', NULL, NULL, '0000-00-00', 'Male', '', '', '', NULL, 'Active', NULL, NULL);
...
CREATE TABLE `teachers` (
  ...
  `type` enum('Permanent','Part time') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Permanent',
  `remarks` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('Active','Inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
(29, 'Rajib', 'Hasan', 'razibeee2014@gmail.com', NULL, '456456456', NULL, NULL, 1, 'Admin', NULL, 0, '$2y$10$Y/uvlLwHx0MLkStdddi8AuXBM1IfymN7235bzKx4ipthkLpYLCg8S', NULL, NULL, '2021-07-14 06:43:53', '2021-08-01 21:56:16'),
...
(185, 'asdf', 'sadf', 'razibeee20114@gmail.com', NULL, '055', 'sdf', 22, 1, 'School', NULL, 1, '$2y$10$QL3oREdZqahvBQPwVDgeBOFP/uc/uBPkY0DaRWlDsCYrMSVqrTm9W', NULL, NULL, '2021-07-30 23:15:10', '2021-08-01 00:39:29');
...
(360, 2, 100, 0, '2021-07-25 11:59:14', '2021-07-25 11:59:14'),
...
(372, 2, 103, 0, '2021-08-01 01:04:23', '2021-08-01 01:04:23'),
...
(376, 2, 104, 0, '2021-08-01 01:05:16', '2021-08-01 01:05:16'),
...
(380, 2, 105, 0, '2021-08-01 01:05:38', '2021-08-01 01:05:38'),
...
(384, 2, 106, 0, '2021-08-01 01:05:55', '2021-08-01 01:05:55'),
...
(388, 2, 107, 0, '2021-08-01 01:08:13', '2021-08-01 01:08:13'),
...
(392, 2, 108, 0, '2021-08-01 01:08:38', '2021-08-01 01:08:38'),
...
(396, 2, 109, 0, '2021-08-01 01:09:23', '2021-08-01 01:09:23'),
...
(400, 2, 110, 0, '2021-08-01 01:09:40', '2021-08-01 01:09:40'),
