...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/print.css') }}" type="text/css" media="print"/>	<link rel="stylesheet" href="{{ asset('assets/css/common.css') }}" rel="stylesheet">
    <link rel="icon" href="{{ asset('assets/images/admin-upload/ace-logo.png')}}" type="image/png" />
    <link  href="https://code.jquery.com/ui/1.11.3/themes/smoothness/jquery-ui.css"  rel="stylesheet" >
    @yield('style')
</head>

<body>
@if(\Illuminate\Support\Facades\Auth::user()->type =='Admin' || \Auth::user()->type=='School' || \Auth::user()->type == 'Teacher')
    <style>
        .vertical-nav-menu.metismenu li:nth-child(5) {
            display: none;
        }
        .vertical-nav-menu.metismenu li ul li:nth-child(5) {
            display: block;
        }
    </style>
    @endif
