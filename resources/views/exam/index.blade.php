                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs quiz-tabs">
                                <li class="nav-item" id="assignments">
                                    <a data-toggle="tab" href="#assignment_list" class="active nav-link" id="assignments">Exam List</a>
                                </li>
                                @if($actions['add_permission']>0)
                                    <li class="nav-item">
                                        <a data-toggle="tab" href="#add_assignment" class="nav-link" id="assignment_title_button"> Add Exam</a>
                                    </li>
                                @endif
                                    ...
                                    <div class="card-body">
                                        <form id="assignment_form" enctype="multipart/form-data" class="form form-horizontal">
                                            ...
                                            <div class="position-relative row form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" data-format="dd-MM-yyyy hh:mm:ss" name="deadline" id="deadline" value="2021-09-18 00:00:00" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="position-relative row form-group">
...
@section('JScript')
    <script type="text/javascript" src="{{ asset('assets/js/page-js/quiz/exam.js')}}"></script>
@endsection
