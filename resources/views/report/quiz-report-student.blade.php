    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-heading">
                        <div>
							...
							<span class="d-inline-block pr-2">
                                ...
                                <span class="d-inline-block"> Quiz Students Report </span>
                            </div>
            ...
            <div class="main-card mb-2 card" >
                    ...
                    <form class="alert alert-dark mb-0" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 p-1">
                                <div class="position-relative">
                                    <button type="submit" id="show_quiz_report_student_status_report" class="btn btn-primary btn-block"><i class="fa fa-fw" aria-hidden="true"></i> Search </button>
                                </div>
                            </div>
                        </div>
                    </form>
                    <h5 class="pt-2 pb-2">Subject: {{ $subject_name->subject_name }},  Quiz TItle: {{ $quiz->title }}</h5>
                    <div class="p-1 alert alert-info alert-dismissible fade show" role="alert">
				<span class="pr-2">
                ...
                <div class="card-body" >
                    <div id='report-data'>
                        <table id="quiz_report_student_report_table" class="table table-hover table-striped table-bordered">
                            <thead>
                            <tr>
                                <th> First Name </th>
                                <th> Last Name </th>
...
@section('JScript')
    ...
    <script type="text/javascript">
        $('.quizviewreport:nth-child(1)').trigger('click');
    </script>
@endsection
