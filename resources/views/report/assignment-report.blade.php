    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-heading">
                        <div>
							...
							<span class="d-inline-block pr-2">
                                ...
                                <span class="d-inline-block"> Assignment Report </span>
                            </div>
            ...
            <div class="main-card mb-3 card" >
                    ...
                    <form class="alert alert-dark mb-0" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 p-1">
                                <div class="position-relative">
                                    <button type="submit" id="show_assignment_status_report" class="btn btn-primary btn-block"><i class="fa fa-fw" aria-hidden="true"></i> Search </button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body" >
                    <div id='report-data'>
                        <table id="assignment_report_table" class="table table-hover table-striped table-bordered">
                            <thead>
                            <tr>
                                <th width="30%"> Name </th>
