    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="main-card mb-2 card">
                ...
                <div class="card-body report-form ">
                    <form class="alert alert-dark mb-0" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 p-1">
                                <div class="position-relative">
                                    <button type="submit" id="show_quiz_subjects_status_report" class="btn btn-primary btn-block"><i class="fa fa-fw" aria-hidden="true"></i> Search </button>
                                </div>
                            </div>
                        </div>
                    </form>
                    <h5 class="p-2">Subject Name: {{ $Subject_name->subject_name }}</h5>
                ...
                <div class="card-body" >
                    <div id='report-data'>
                        <table class="table table-bordered table-hover course_table" id="quiz_subjects_report" style="width:100% !important">
                            <thead>
                            <tr>
                                <th> Quiz Name </th>
