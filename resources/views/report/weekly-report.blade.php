    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="main-card mb-3 card" >
                        ...
                        <form class="mb-0 alert alert-dark"  enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 p-1">
                                    <div class="position-relative">
                                        <button type="submit" class="btn btn-primary btn-block" id="show_weekly_status_report"><i class="fa fa-fw" aria-hidden="true"></i> Search </button>
                                    </div>
                                </div>
                                <div class="col-md-4 ">
                ...
                <div class="card-body" >
                    <div id='report-data'>
                        <table id="weekly_report_table" class="table table-hover table-striped table-bordered">
                            <thead>
                            <tr>
                                <th>  Last Name  </th>
                                <th class="text-center" width="15%">  First Name  </th>
                                <th class="text-center" width="15%"> 3 Weeks Ago </th>
                                <th class="text-center" width="15%">2 Weeks Ago</th>
                                <th class="text-center" width="15%">Last Week</th>
                                <th class="text-center" width="15%">This Week</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
