    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-heading">
                        <div>
							...
							<span class="d-inline-block pr-2">
                                ...
                                <span class="d-inline-block"> Student Subject Report </span>
                            </div>
            ...
            <div class="main-card mb-2 card" >
                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 p-1">
                                            <div class="position-relative">
                                                <input type="date" value="{{ date('Y-m-d', strtotime('today - 30 day')) }}" name="form_date" class="form-control search-box-quiz" id="form_date"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2 p-1">
                                            <div class="position-relative">
                                ...
                                <div class="col-md-1 p-1">
                                    <div class="position-relative">
                                        <button type="submit" id="show_student_subjects_status_report" class="btn btn-primary btn-block"><i class="fa fa-fw" aria-hidden="true"></i> Search </button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    <h4 class="pt-2 pb-2">Exercise Report for ({{ $student_name->first_name  }} {{ ($student_name->first_name) ==null ? '':$student_name->last_name }}) </h4>
                ...
                <div class="card-body" >
                    <div id='report-data'>
                        <table id="student_subject_report_table" class="table table-hover table-striped table-bordered">
                            <thead>
                            <tr>
                                <th> Subject </th>
                                <th> Quizzes </th>
