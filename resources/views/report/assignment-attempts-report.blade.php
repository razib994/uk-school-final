    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-heading">
                        <div>
							...
							<span class="d-inline-block pr-2">
                                ...
                                <span class="d-inline-block"> Assignment Exams Report </span>
                            </div>
            ...
            <div class="main-card mb-2 card" >
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 p-1">
                                        <div class="position-relative">
                                            <select name="quiz_name" id="quiz_id" class="form-control search-box-quiz">
                                                <option value="default"> Select Quiz </option>
                                            </select>
                                        </div>
                                    </div>
                                    @php
                                    ...
                                    <div class="col-md-2 p-1">
                                        <div class="position-relative">
                                            <input type="date" name="form_date" value="{{ date('Y-m-d', strtotime('today - 30 days')) }}" class="form-control search-box-quiz" id="form_date"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2 p-1">
                                        <div class="position-relative">
                                            <input type="date" name="to_date" class="form-control search-box-quiz" value="{{ date('Y-m-d', strtotime('today + 1 days')) }}" id="to_date"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1 p-1">
                                <div class="position-relative">
                                    <button type="submit" id="show_assignment_attempts_status_report" class="btn btn-primary btn-block"><i class="fa fa-fw" aria-hidden="true"></i> Search </button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body" >
                    <div id='report-data'>
                        <table id="assignment_attempts_report_table" class="table table-hover table-striped table-bordered">
                            <thead>
                            <tr>
                                <th width="30%"> Name </th>
                                <th width="10%"> Completed </th>
                                <th class="text-center" width="10%"> Quizzes </th>
                                <th class="text-center" width="22%"> From </th>
                                <th class="text-center" width="22%">To</th>
